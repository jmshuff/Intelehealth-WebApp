...
//       // var a = result[0].value ? result[0].value =[]: result[0].value
//       if (result.length !== 0) {
...
//   submit() {
//     const visitId = this.route.snapshot.params["visit_id"];
//     var formValue = this.interaction.value;
...
//           //     .subscribe(response1 => {
//           //         this.msg.push({ uuid: response1.uuid, value: this.interaction.value.interaction  });
//           //     });
//           //   // this.msg.push({ uuid: result[0].uuid, value: this.interaction.value.interaction });
//           //   }else{
//           //     formValue = this.interaction.value
//           //   }
//         } else {
//           const json = {
//             attributeType: "6cc0bdfe-ccde-46b4-b5ff-e3ae238272cc",
