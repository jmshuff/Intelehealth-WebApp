    ...
    let steps = [
      {
        ...
        intro:
          "Welcome to the Doctor portal. In less than 1 min, we will show you how to give diagnosis, medicines,test and advice to a patient.",
      },
      {
      ...
      },
      {
        ...
        // tslint:disable-next-line: max-line-length
        intro:
          "These are visits that are marked as priority by health worker. Tip - Always provide consultation for priority visit table first.",
        position: "right",
      },
      {
      ...
      },
      {
        ...
        intro:
          "These are visits that are seen by the doctor and have been partially provided a consultation",
        position: "right",
      },
      {
      ...
      },
      {
        ...
        intro:
          "Click on patient id to add doctor's prescription for the patient.",
      },
      {
        element: "#logout-link",
      ...
      steps = [
        {
          element: "#past-visits",
          intro:
            "Click on the visit date to see the patient record for that visit and schedule.",
        },
        {
          element: "#start-visit",
          intro:
            "Click on start visit/here to write diagnosis, medications, tests, advice and follow up's",
        },
        {
          element: "#call-link",
        ...
        },
        {
          ...
          intro:
            "Select from PRIMARY AND SECONDARY and from PROVISIONAL and CONFIRMED ",
        },
        {
        ...
        },
        {
          ...
          // tslint:disable-next-line: max-line-length
          intro:
            "Write information such as reference notes, patients call notes etc and click on 'Add Note'. These notes are not shared with the patient.",
        },
        {
          element: "#medication-form",
          // tslint:disable-next-line: max-line-length
          intro:
            "Type the name of the medicines and choose from drop down options. If the name is not available on the drop down options you can type the name.",
        },
        {
          element: "#test-form",
          intro:
            "Write or choose from drop down options of tests and click on 'Add Test'",
        },
        {
          element: "#advice-form",
          intro:
            "Write or choose from drop down options of advise and then click on 'Add Advice'",
        },
        {
          element: "#followup-button",
          intro:
            "Click on calender icon and select follow up date. Write remarks and click on 'Schedule a follow up'",
        },
        {
          element: "#sign-button",
          intro:
            "Review the prescription and click on 'Sign and Submit' to send the prescription to the health worker.",
        },
      ];
      this.introJS
        .setOptions({
